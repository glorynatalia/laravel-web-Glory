...
@section('title', 'daftar Pelamnggan')
@section('content')
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            ...
            <div>
                <a href="{{ route('pelanggan.index') }}" class="btn btn-success text-white"><i
                                        ...
                                        <td><a href="" class="btn btn-info btn-sm">
                                                <svg class="icon icon-xs me-2" data-slot="icon" fill="none"
                                                    ...
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        ...
                                                        1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25
